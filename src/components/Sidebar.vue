    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Cairo Team</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Modifications' ? activeClass : inactiveClass]"
          to="/modifications"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Modifications</span>
        </router-link>
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'PublicNotification' ? activeClass : inactiveClass]"
          to="/public_notification"
        >
          ...
          <span class="mx-4">Send Public Notification</span>
        </router-link>
